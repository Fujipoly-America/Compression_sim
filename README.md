[README (1).md](https://github.com/user-attachments/files/32426459/README.1.md)
...
Install the following packages to run the notebook locally:

```bash
pip install numpy pandas scipy matplotlib pillow jupyter
```

Then launch Jupyter and open `Rate_Dependent_PAD_PCB_Stack_Calculator.ipynb`.
